...
<div class="window-container">
  ...
  <header class="custom-titlebar" style="display: flex; align-items: center; justify-content: space-between; padding: 0 12px; height: 32px; background-color: var(--bg-sidebar); border-bottom: 1px solid var(--border-color); user-select: none;">
    <!-- Left: App Logo, Title (DRAGGABLE) -->
    <div class="titlebar-left" data-tauri-drag-region style="display: flex; align-items: center; flex: 1; height: 100%; cursor: default;">
      <div class="app-logo" style="display: flex; align-items: center; justify-content: center; width: 28px; height: 28px; margin-right: 8px; pointer-events: none;">
      ...
      <span class="titlebar-app-name" style="font-size: 12px; font-weight: 500; color: var(--text-primary); user-select: none; pointer-events: none;">Bayesian SSH</span>
    </div>

    <!-- Center: Profile Indicator (DRAGGABLE) -->
    <div class="titlebar-center" data-tauri-drag-region style="display: flex; justify-content: center; align-items: center; flex: 1; height: 100%; cursor: default;">
      <div class="titlebar-search-bar" style="background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 4px; padding: 4px 16px; font-size: 11px; color: var(--text-secondary); display: flex; align-items: center; gap: 6px; user-select: none; pointer-events: none;">
    ...
    <div class="titlebar-right" style="display: flex; align-items: center; justify-content: flex-end; flex: 1; height: 100%;">
      <button class="win-ctrl-btn minimize" onclick={handleWindowMinimize} title="Minimize" style="position: relative; z-index: 9999; display: flex; align-items: center; justify-content: center; width: 46px; height: 32px; background: none; border: none; color: var(--text-secondary); cursor: pointer;">
      ...
      <button class="win-ctrl-btn maximize" onclick={handleWindowMaximize} title="Maximize/Restore" style="position: relative; z-index: 9999; display: flex; align-items: center; justify-content: center; width: 46px; height: 32px; background: none; border: none; color: var(--text-secondary); cursor: pointer;">
      ...
      <button class="win-ctrl-btn close" onclick={handleWindowClose} title="Close" style="position: relative; z-index: 9999; display: flex; align-items: center; justify-content: center; width: 46px; height: 32px; background: none; border: none; color: var(--text-secondary); cursor: pointer;">
